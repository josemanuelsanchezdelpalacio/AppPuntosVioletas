...
/*
* sealed class Item(val id: Int, val name: String)

data class SelectableItem(val itemId: Int, val itemName: String, var isSelected: Boolean = false) : Item(itemId, itemName)

data class NonSelectableItem(val itemId: Int, val itemName: String) : Item(itemId, itemName)
*
* val items = listOf(
    SelectableItem(1, "Item 1"),
    NonSelectableItem(2, "Item 2"),
    SelectableItem(3, "Item 3"),
    NonSelectableItem(4, "Item 4"),
    SelectableItem(5, "Item 5")
)
*
* @Composable
...
@Composable
fun CheckboxItem(item: SelectableItem) {
    Row(modifier = Modifier.clickable { item.isSelected = !item.isSelected }) {
...
@Composable
fun TextItem(item: NonSelectableItem) {
    Text(text = item.name)
}
